...
class DepositCalculatorUseCase {
  Result<Failure, double> calculateFinalValue(RegularDeposit params) {
    late double result;
  ...
  Result<Failure, double> calculateDepositAmount(RegularDeposit params) {
    double r = params.rate / 100;
    ...
    double result = params.finalValue /
        (((pow(1 + r, params.months) - 1) / r) * (1 + r));
    return SuccessResult<Failure, double>(result);
  }

  Result<Failure, int> calculateNumberOfMonths(RegularDeposit params) {
    late int result;
    double r = params.rate / 100;
    ...
    result = (log((fvAjustado * r / params.depositAmount) + 1) /
            log(1 + r))
        .round();
  ...
  Result<Failure, double> calculateInterestRate(RegularDeposit params) {
